...
const Card = ({ _id, name, prompt, photo }) => {
  return (
    <div className="rounded-xl group relative shadow-card transition duration-700 ease-in-out hover:shadow-cardhover card">
      <img
      ...
      <div className="group-hover:flex flex-col max-h-[94.5%] hidden absolute bottom-0 left-0 right-0 bg-[#10131f] p-4 rounded-md">
        ...
        <div className="mt-5 flex justify-between items-center gap-2">
          ...
          <button
            ...
            className="outlone-none bg-transparent border-none"
          >
            <img
              src={download}
              alt="download"
